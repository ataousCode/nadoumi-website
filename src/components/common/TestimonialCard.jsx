...
function TestimonialCard({ quote, author, university, image }) {
  return (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-md transition-shadow">
      ...
      <p className="text-gray-600 italic mb-8 flex-1 leading-relaxed">
        "{quote}"
      </p>
      
      <div className="flex items-center gap-4">
        {image ? (
          <img src={image} alt={author} className="w-12 h-12 rounded-full object-cover border-2 border-orange-50" />
        ) : (
